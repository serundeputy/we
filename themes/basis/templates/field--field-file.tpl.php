  ...
  <div class="field-items"<?php print backdrop_attributes($content_attributes); ?>>
    <?php foreach ($items as $delta => $item): ?>
      <div class="field-item <?php print $delta % 2 ? 'odd' : 'even'; ?>"
        <?php print backdrop_attributes($item_attributes[$delta]); ?>><?php print render($item); ?>
      </div>
      <audio controls="controls">
        <source
          src="<?php print 'files/rehearsals/' . $item['#file']->filename; ?>"
          type="<?php print $item['#file']->filemime; ?>"
        />
      </audio>
    <?php endforeach; ?>
  </div>
